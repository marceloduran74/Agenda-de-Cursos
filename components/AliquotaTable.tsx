...
export const AliquotaTable: React.FC<AliquotaTableProps> = ({ aliquotaData, feesData, onUpdateAliquota, onUpdateFee }) => {
  ...
  return (
    <div className="bg-slate-800 rounded-xl shadow-lg shadow-black/20 overflow-hidden">
      <div className="p-4 bg-slate-700/50 border-b border-slate-700">
        <h2 className="text-xl font-bold text-slate-100">Alíquota Simples 2025</h2>
      </div>
